...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update tblpricelist set TopWear='$topwear',  BottomWear='$bottomwear',  Woolen='$woolen', Suit='$Suit', Duvet='$Duvet', Curtains='$Curtains', Carpets='$Carpets' where Id='$eid'");
    if ($query) {
...
?>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="Suit" name="Suit" class="form-control"  required="required" value="<?php  echo $row['Suit'];?>">
              <label for="Suit">Suit Price</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="Duvet" name="Duvet" class="form-control"  required="required" value="<?php  echo $row['Duvet'];?>">
              <label for="Duvet">Duvet Price</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="Curtains" name="Curtains" class="form-control"  required="required" value="<?php  echo $row['Curtains'];?>">
              <label for="Curtains">Curtains Price</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="Carpets" name="Carpets" class="form-control"  required="required" value="<?php  echo $row['Carpets'];?>">
              <label for="Carpets">Carpets Price</label>
            </div>
          </div>
